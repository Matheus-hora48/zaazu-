      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-gray-600 mt-1">
            Crie grades para diferentes categorias: entretenimento, atividade e educativo. Você pode ativar uma grade de cada categoria simultaneamente.
          </p>
        </div>
        <Button
      ...
      <Card className="bg-gradient-to-r from-green-50 to-blue-50 border-green-200">
        <CardHeader>
          ...
          <CardDescription className="text-green-700">
            Estas são as grades que estão aparecendo na tela inicial do app das crianças
          </CardDescription>
        </CardHeader>
        <CardContent>
