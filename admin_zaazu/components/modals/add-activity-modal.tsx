...
export function AddActivityModal({
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    e.preventDefault();
    if (!formData.title.trim() || !formData.description.trim() || !formData.tag)
      return;
            ...
            <CardContent className="space-y-6">
              ...
              <div>
                ...
                <textarea
                  ...
                  className="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 text-gray-900 resize-none h-24 bg-white"
                  required
                />
              </div>
              ...
              <div>
                ...
                <div className="space-y-2">
                  ...
                  <Button
                    ...
                    variant="outline"
                    size="sm"
                    className="w-full border-dashed text-gray-900 mt-2"
                  >
